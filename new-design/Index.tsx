...
<nav>
  ...
  <div className="nav-links">
    {/*  Expandable tab nav  */}
    <div className="exp-tabs" id="exp-tabs">
      <button className="exp-tab" data-index="0" onClick="selectTab(0)">
        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round"><path d="M3 9.5L12 3l9 6.5V20a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1V9.5z"/><path d="M9 21V12h6v9"/></svg>
        <span className="exp-label">Home</span>
      </button>
      <button className="exp-tab" data-index="1" onClick="selectTab(1)">
        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round"><polyline points="22 12 18 12 15 21 9 3 6 12 2 12"/></svg>
        <span className="exp-label">Live</span>
      </button>
      <button className="exp-tab" data-index="2" onClick="selectTab(2)">
        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"/><polygon points="10 8 16 12 10 16 10 8"/></svg>
        <span className="exp-label">Replay</span>
      </button>
      <div className="exp-sep"></div>
      <button className="exp-tab" data-index="3" onClick="selectTab(3)">
        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round"><path d="M13 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V9z"/><polyline points="13 2 13 9 20 9"/></svg>
        <span className="exp-label">Events</span>
      </button>
      <button className="exp-tab" data-index="4" onClick="selectTab(4)">
        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="3" width="7" height="7"/><rect x="14" y="3" width="7" height="7"/><rect x="3" y="14" width="7" height="7"/><rect x="14" y="14" width="7" height="7"/></svg>
        <span className="exp-label">Heatmap</span>
      </button>
    </div>

    <button id="theme-toggle" onClick="toggleTheme()" aria-label="Toggle theme" style={{width: '34px', height: '34px', borderRadius: '50%', border: 'none', cursor: 'pointer', background: 'var(--dvr-btn-bg)', color: 'var(--fg)', display: 'flex', alignItems: 'center', justifyContent: 'center', transition: 'background 0.2s,color 0.2s', fontSize: '15px'}}>🌙</button>
...
<section className="hero">
  <div className="hero-video-bg">
    <video autoplay muted loop playsinline src="file:///C:/Users/BASHIR/Downloads/marketdvr.mp4"></video>
  </div>
  <div className="hero-left">
    ...
    <h1>Record every<br><span className="word-cycler" id="word-cycler">
    ...
    <div className="ctas">
      ...
      <a href="#" className="cta-secondary">Replay an Event</a>
    </div>
        ...
        <svg viewBox="0 0 360 80" preserveAspectRatio="none">
          <defs>
            <linearGradient id="g" x1="0" y1="0" x2="0" y2="1">
              <stop offset="0%" stop-color="rgba(230,0,122,0.28)"/>
              <stop offset="100%" stop-color="rgba(230,0,122,0)"/>
            </linearGradient>
          </defs>
          {/*  event zone  */}
          ...
          {/*  playhead  */}
          <line id="ph" x1="265" y1="0" x2="265" y2="80" stroke="rgba(255,255,255,0.45)" strokeWidth="1" strokeDasharray="3 3"/>
        </svg>
      </div>
...
{/*  ── RECENT EVENTS (removed from home, will be its own page)  */}
  ...
  <div className="max-container">
    <div className="events-header">
      ...
      <div className="events-filters" id="events-filters">
        <button className="ef-btn ef-active" data-filter="all" onClick="filterEvents('all', this)">
          <span className="ef-icon">⬡</span> All
        </button>
        <button className="ef-btn" data-filter="crash" onClick="filterEvents('crash', this)">
          <span className="ef-icon ef-crash">▼</span> Crash
        </button>
        <button className="ef-btn" data-filter="pump" onClick="filterEvents('pump', this)">
          <span className="ef-icon ef-pump">▲</span> Pump
        </button>
        <div className="ef-sep"></div>
        <button className="ef-btn" data-filter="spread" onClick="filterEvents('spread', this)">
          <span className="ef-icon ef-spread">↔</span> Spread Spike
        </button>
        <button className="ef-btn" data-filter="confidence" onClick="filterEvents('confidence', this)">
    ...
    <div className="events-grid" id="events-grid">
      {/*  crash  */}
      <div className="ev-card" data-type="crash">
      ...
      {/*  pump  */}
      <div className="ev-card" data-type="pump">
        <div className="ev-top">
      ...
      {/*  spread  */}
      <div className="ev-card" data-type="spread">
        <div className="ev-top">
      ...
      {/*  confidence  */}
      <div className="ev-card" data-type="confidence">
        <div className="ev-top">
...
<section className="how">
  <div className="how-grid">
    <div className="how-left">
      ...
      <h2>Markets move<br>in milliseconds.<br><span className="dim">Now you can too.</span></h2>
    </div>
    <div className="steps">
      <div>
...
<section className="cta-section">
  <div className="cta-grid">
    ...
    <div className="cta-stack">
      <a href="#" className="cta-btn-primary">Start Recording</a>
      <a href="#" className="cta-btn-secondary">Browse Recorded Events</a>
    </div>
  </div>
</section>
...
<footer>
  <div className="footer-logo">
    <div className="nav-dot"></div>
    <span style={{fontSize: '14px', fontWeight: '500', letterSpacing: '-0.02em'}}>Market DVR</span>
  </div>
...
document.addEventListener('click', (e) => {
  if (!e.target.closest('#exp-tabs') && activeTabIndex !== null) {
...
function filterEvents(type, btn) {
  document.querySelectorAll('.ef-btn').forEach(b => b.classList.remove('ef-active'));
...
// Word cycler
(function() {
  const words = ['millisecond.', 'crash.', 'pump.', 'spike.', 'tick.', 'moment.'];
  const container = document.getElementById('word-cycler');
  let current = 0;

  // Build word spans — all hidden below except first
  const spans = words.map((w, i) => {
    const s = document.createElement('span');
    s.className = 'wc-word ' + (i === 0 ? 'wc-active' : 'wc-below');
    s.textContent = w;
  ...
  function cycle() {
    ...
    spans[prev].classList.remove('wc-active');
    spans[prev].classList.add('wc-exit');

    // Next word starts below (already has wc-below), force reflow, then activate
    spans[current].classList.remove('wc-below');
    spans[current].getBoundingClientRect(); // force reflow
    spans[current].classList.add('wc-active');

    // After exit transition, reset to below for reuse
    const exiting = spans[prev];
    exiting.addEventListener('transitionend', () => {
      exiting.classList.remove('wc-exit');
      exiting.classList.add('wc-below');
    }, { once: true });
  }
